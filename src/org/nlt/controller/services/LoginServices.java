...
public class LoginServices 
{
	...
	public boolean loginUserService(String email, int password) throws Exception
	{
	...
	public boolean signupUserService(String name, String email,String phone) throws Exception
	{
		Users user=new Users();
		user.setName(name);
		user.setEmail(email);
