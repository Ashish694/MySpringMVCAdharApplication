...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				<img alt="image" src="<c:url value="/res/images/aadharreg.jpg"/>" height="300px" width="190px" />
			</div>
			<div class="col-md-7">
				...
				<div class="form-group">
				  ...
				  <a href="./login" style="color: blue; text-decoration: none"><b>Already have an account? login here.</b></a>
